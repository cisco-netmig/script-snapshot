...
## Usage 
- Add network devices to run commands on.  
- Select the necessary "show" commands to execute.  
- Click the "Run" button to execute commands.  
- Access logs via the "Folder" button.  
